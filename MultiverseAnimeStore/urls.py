...
from .views import (
    ...
    panel_roles_editar,
    panel_perfiles_list,
    panel_perfiles_crear,
    panel_perfiles_editar,
    panel_perfiles_permisos,
    panel_sexos_list,
    panel_sexos_editar,
    panel_sexos_crear,
    panel_estados_list,
...
urlpatterns = [
    ...
    path('panel/roles/crear/', panel_roles_crear, name='panel_roles_crear'),
    path('panel/roles/<int:pk>/editar/', panel_roles_editar, name='panel_roles_editar'),
    path('panel/perfiles/', panel_perfiles_list, name='panel_perfiles'),
    path('panel/perfiles/crear/', panel_perfiles_crear, name='panel_perfiles_crear'),
    path('panel/perfiles/<int:pk>/editar/', panel_perfiles_editar, name='panel_perfiles_editar'),
    path('panel/perfiles/<int:pk>/permisos/', panel_perfiles_permisos, name='panel_perfiles_permisos'), 
